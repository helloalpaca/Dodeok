...
public class EmotionStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emotion_student);
    ...
    private void EmotionData() {
        ...
        String serverURL = "classname=" + myClassname + "&id=" + StudentID;
