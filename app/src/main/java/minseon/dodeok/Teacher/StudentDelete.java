...
public class StudentDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String getString = getIntent().getStringExtra("StudentName");

        btn_yes2 = (Button)findViewById(R.id.btn_yes2);
        btn_no2 = (Button)findViewById(R.id.btn_no2);
        textview_studentadd = (TextView)findViewById(R.id.textview_studentadd);

        textview_studentadd.setText("'"+getString+"'"+"학생을\n 삭제하시겠습니까?");

    }

    public void onClickStudentDeleteButton1(View view){
        GetStudentDelete task = new GetStudentDelete();
        task.execute();

        Intent intentHome = new Intent(StudentDelete.this, ManageStudent.class);
        intentHome.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intentHome);
    }

    public void onClickStudentDeleteButton2(View view){
        onBackPressed();
    }

    private class GetStudentDelete extends AsyncTask<String,Void,String> {
        ProgressDialog progressDialog;
        String errorString = null;
        String mJsonString;


        public String StudentDelete_URL = MainURL + "studentdelete.php/";
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                URL url = new URL(StudentDelete_URL);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(StudentDelete.this, "Please Wait", null, true, true);
        }
