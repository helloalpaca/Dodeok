...
import static minseon.dodeok.Student.Emotion2.game_emotion;
...
public class Grade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = (ImageButton)findViewById(R.id.grade_btn1);
        btn2 = (Button)findViewById(R.id.grade_btn2);
        ratingBar = (RatingBar)findViewById(R.id.ratingBar);
        text1 = (TextView)findViewById(R.id.grade_text1);
        text2 = (TextView)findViewById(R.id.grade_text2);
        text3 = (TextView)findViewById(R.id.grade_text3);
        view1 = (View)findViewById(R.id.grade_view1);
    ...
    public void onClickGradeButton1(View view){
        Intent intent = new Intent(Grade.this, Game.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        startActivity(intent);
    }

    public void onClickGradeButton2(View view){
        if(!flag) {
            answer = String.valueOf(ratingBar.getRating());
            Intent intent = new Intent(Grade.this, Emotion2.class);
            startActivity(intent);
